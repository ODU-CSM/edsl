...
class DeepSEA8Synt(nn.Module):
    def __init__(self, sequence_length, n_targets, mode = 'pred'):
        super(DeepSEA8Synt, self).__init__()
        conv_kernel_size = 8
        pool_kernel_size = 3
    ...
    def forward(self, x):
        ...
        """
        out = self.bn3(self.relu3(self.conv3(self.bn2(self.pool2(self.relu2(self.conv2(self.bn1(self.pool1(torch.exp(self.conv1(x)))))))))))
